                    ...
                    <View style={{ height: welcomContHeight, width: 'screenWidth' }}>
                        ...
                        <View>
                            ...
                            <Text style={styles.rptCardTxt}>Download</Text>
                                ...
                                <View style={[styles.rptBgContainer, { height: rptBgCont }]}>
                                <TouchableOpacity style={styles.rptCard} onPress={() => navigation.navigate('notification')}>
                                        <Image source={require('../assets/circular.png')} style={{ width: 60, height: 60, resizeMode: 'contain' }} />
                                        <Text style={styles.rptCardTxt}>Circular</Text>
                                    </TouchableOpacity>
                                </View>
